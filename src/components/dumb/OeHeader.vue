<template>
  <div class="header">
    <div class="header__title">
      ...
      <h1 class="vl-u-spacer-left--small vl-u-spacer-right--small">Plannen</h1>
    ...
    <div class="header__userinfo">
      ...
      <div class="username vl-u-spacer-left--large vl-u-spacer-right--small">
        <vl-dropdown-navigation class="vl-u-spacer-bottom--none vl-col--12-12" label="Doe, John" title-size="h6">
          <vl-link-list>
            <vl-link-list-item>
              <vl-link href="https://youtu.be/bLHL75H_VEM" mod-block> Dereferencing a null-pointer </vl-link>
            </vl-link-list-item>
            <vl-link-list-item>
              <vl-link href="https://youtu.be/bLHL75H_VEM" mod-block> Altavista </vl-link>
            </vl-link-list-item>
            <vl-link-list-item>
              <vl-link href="https://youtu.be/bLHL75H_VEM" mod-block> Tech tips </vl-link>
            </vl-link-list-item>
          </vl-link-list>
        </vl-dropdown-navigation>
        <small class="vl-col--12-12 role">Beheerder</small>
      </div>
      <div class="logout">
        <vl-icon icon="logout"></vl-icon>
      </div>
    </div>
  </div>
</template>
